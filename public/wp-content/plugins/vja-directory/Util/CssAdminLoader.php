...
class CSSAdminLoader implements AssetsInterface 
{
    ...
    public function enqueue() {
        ...
        wp_enqueue_style(
            'cad-directory-admin-style',
            plugins_url( 'cad-directory-admin-style.css', VJADIRECTORY_PLUGIN_PATH ."/css/cad-directory-admin-style.css" ),
            array(),
            filemtime( VJADIRECTORY_PLUGIN_PATH . 'css/cad-directory-admin-style.css' )
        );
